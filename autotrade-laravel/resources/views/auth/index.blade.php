...
<style>
    :root {
        --at-bg: #020617;          /* page background (very dark blue) */
        --at-bg-soft: #020617;
        --at-card: #0b1220;        /* card / panel background (gunmetal / dark navy) */
        --at-border: #1f2937;
        --at-text: #e5e7eb;
        --at-muted: #9ca3af;
        --at-accent: #4f46e5;      /* primary blue */
    ...
    .auth-radio-row input[type="radio"] {
        ...
        <div class="auth-hero">
            <div class="auth-hero-inner">
                <div class="auth-logo-pill">
                    ...
                    <span class="auth-logo-pill-label">Live marketplace</span>
                </div>
                <h1 class="auth-hero-title">
                    Find your next car<br>with confidence.
                </h1>
                <p class="auth-hero-subtitle">
                    Sign in to save searches, compare favorites, and sync your garage
                    across devices.
                </p>
        ...
        <div class="auth-card">
            <div class="auth-header">
                <div>
                    ...
                    <div class="auth-header-subtitle">
                        {{ $active === 'login'
                            ? 'Sign in to access your saved searches and watchlist.'
                            : 'Sign up as a buyer or seller to start using Autotrade.' }}
                    </div>
                </div>

                <div class="auth-tabs">
                    <a class="auth-tab {{ $active === 'login' ? 'active' : '' }}"
                       href="{{ route('auth.page', ['tab' => 'login']) }}">
                        Login
                    </a>
                    <a class="auth-tab {{ $active === 'register' ? 'active' : '' }}"
                       href="{{ route('auth.page', ['tab' => 'register']) }}">
                        Sign up
                    </a>
                </div>
            </div>
            ...
            @if ($errors->any())
                <div class="auth-alert">
                    {{ $errors->first('auth') ?? $errors->first() }}
                </div>
            @endif
            ...
            @if ($active === 'login')
                ...
                <div class="auth-footer">
                    New to Autotrade?
                    <a href="{{ route('auth.page', ['tab' => 'register']) }}">Create an account</a>
                </div>
            @endif
            ...
            @if ($active === 'register')
                ...
                <div class="auth-footer">
                    ...
                    <a href="{{ route('auth.page', ['tab' => 'login']) }}">Log in instead</a>
                </div>
            @endif
        </div>
    </div>
