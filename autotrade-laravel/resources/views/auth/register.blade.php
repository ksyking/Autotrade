<x-guest-layout>
    {{-- Reuse the same styles as login for consistent look --}}
    <style>
        /* You can keep this identical to the login styles for simplicity */
        :root {
            --at-bg: #020617;
            --at-bg-soft: #020617;
            --at-card: #0b1220;
        ...
        <div class="auth-wrapper">
            ...
            <div class="auth-hero">
                <div class="auth-hero-inner">
                    <div class="auth-logo-pill">
                        ...
                        <span>Autotrade account</span>
                    </div>
                    <h1 class="auth-hero-title">
                        Join the marketplace.
                    </h1>
                    <p class="auth-hero-subtitle">
                        Create an account to save searches, build your watchlist,
                        and get notified when the right vehicle hits the lot.
                    </p>
                </div>
            </div>
            ...
            <div class="auth-card">
                <div class="auth-header">
                    <div>
                        <div class="auth-header-title">Create your account</div>
                        <div class="auth-header-subtitle">
                            Sign up to start buying or selling on Autotrade.
                        </div>
                    </div>

                    <div class="auth-tabs">
                        <a class="auth-tab" href="{{ route('login') }}">Login</a>
